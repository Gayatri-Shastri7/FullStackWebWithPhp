...
if(isset($_GET['i_id'])){
  $id = $_GET['i_id'];
  $internship = $internship->fetch_data($id);
...
<head>
	...
	<title>Save The Paws - Careers</title>
...
<div class="card " style="color:black;">
      ...
      <div class="card-body border border-black">
        <h4 class="p-2 h4-responsive float-left"><span class="highlight"><?=$internship['i_category'];?></span></h4>
        <h5 class="p-2 h5-responsive "><span class="details-bold"> <i style="font-size:14px" class="material-icons">place</i>Location: </span><?=$internship['i_location'];?></h5>
        <table class="table table-bordered border border-dark">
          <thead>
            <th class="border border-dark"><span class="details-bold"><span class="material-icons" style="font-size:15px">
today
</span> Duration</span></th>
            <th class="border border-dark"><span class="details-bold"><i style="font-size:14px" class="material-icons">account_balance_wallet</i> Stipend</span></th>
            <th class="border border-dark"><span class="details-bold"><i style="font-size:14px" class="material-icons">hourglass_full</i>  Apply By</span></th>
            <th class="border border-dark"><span class="details-bold"> Available Positions</span></th>
          </thead>
          <tbody>
            <tr>
              <td  class="border border-dark"><?=$internship['i_duration'];?></td>
              <td  class="border border-dark">&#8377; <?=$internship['i_stipend'];?></td>
              <td  class="border border-dark"><?=$internship['i_applyby'];?></td>
              <td  class="border border-dark"><?=$internship['i_availposition'];?></td>
            </tr>
          </tbody>
        </table>
        <div class="text-justify py-2">
		  <div class="skillsRequired">
            <h4 class="h4-responsive">Skills Required</h4>
            <p class="py-2"><?=nl2br($internship['i_skillsrequired']);?></p>
          </div>
          <div class="aboutInternship">
            <h4 class="h4-responsive">About Internship</h4>
            <p class="py-2"><?=nl2br($internship['i_aboutintern']);?></p>
          </div>
          <div class="positions">
            <h4 class="h4-responsive">No. of positions available</h4>
            <p class="py-2"><?=$internship['i_availposition'];?></p>
          </div>
          <div class="whoCanApply">
            <h4 class="h4-responsive">Who can apply</h4>
            <p class="py-2"><?=nl2br($internship['i_eligibility']);?></p>
          </div>
          <div class="perks">
            <h4 class="h4-responsive">Perks of the internship</h4>
            <p class="py-2"><?=$internship['i_perks'];?></p>
          </div>
          <button type="button" style="background-color:#800000;"class="btn"><a style="color:white;" href="intern_application.php?i_category=<?php echo $internship['i_category'];?>"> Apply </a></button>
        </div>
      </div>
    </div>
</div>
