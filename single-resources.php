...
if(isset($_GET['resource_id'])){
    $id = $_GET['resource_id'];
    $resources = $resource->fetch_data($id);
    $resource_id=$resources['resource_id'];
    $resource_name=$resources['resource_name'];
    $resource_author=$resources['resource_author'];
    $resource_category=$resources['resource_category'];
    $resource_context=$resources['resource_content'];
    $resource_image=$resources['resource_img'];
    $resource_files=$resources['resource_file'];
    $resource_date=$resources['resource_date'];
  $timestamp = strtotime($resource_date);
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="row">
					<div class="col-sm-12 col-md-12">
						<img src="ad/admin/resourceimages/<?php echo $resource_image; ?>" alt="" class="img-fluid">
					</div>
				</div>
							<h2 class="blok-title" style="color:#800000;">
								 <?php echo $resource_name;?>
							</h2>
							<div class="meta">
								<div class="meta-date"><i class="fa fa-clock-o"></i><?php echo $new_date;?></div>
								<div class="meta-author"><strong>POSTED BY: </strong><a href="#"><?php echo $resource_author; ?></a></div>
								<div class="meta-category"> <strong>CATEGORY: </strong><a href="#"><?php echo $resource_category;?></a></div>
								<div class="meta-comment"></div>
							</div>
							<p> 
                            <!-- <div class="margin-bottom-50"></div> -->
                            <?php echo $resource_context;?>
                             </p>
							...
							<div class="body">
                            <a href="ad/admin/uploads/<?php echo $resource_files; ?>"> 
									<h3>View the file</h3>
