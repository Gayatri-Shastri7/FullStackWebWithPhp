...
<body>
			    ...
			    <nav class="navbar navbar-expand-lg">
			        ...
			        <div class="collapse navbar-collapse" id="navbarNavDropdown">
			            <ul class="navbar-nav">
								...
								<li class="nav-item">
									<a class="nav-link" href="#Home 4 - Onepage">HOME</a>
								</li>								
							...
							<li class="nav-item">
			                    <a class="nav-link" href="pfp.php">PET FRIENDLY PLACES</a>
			                </li>
							<li class="nav-item">
							...
							<li class="nav-item">
			                    <a class="nav-link" href="blooddonors.php">BLOOD DONORS</a>
			                </li>
			                <li class="nav-item">
	...
	<h2 class="text-center text-light mb-0">Pet Friendly Places</h2>
</div>
</div>
</div>
</div>
...
<!--listings-->
 <div class="row">
  ...
  <div class="col-sm-2 col-md-2 col-md-2">
    <div class="card">
      <div class="card-body">
       <img class="card-img-top" src="images/res.jpg" alt="Card image cap">
