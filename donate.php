				  ...
				  <ol class="breadcrumb ">
					...
					<div class="col-sm-12 col-md-12">
						<h2 class="section-heading">
							You are Donating for <span><?php echo $cause_name?></span>
						</h2>
						<div class="section-subheading">Please enter the following  details to proceed further</div>
						<div class="margin-bottom-50"></div>

						<div class="content">
							<form action="pay.php" method="POST"  data-toggle="validator" novalidate="true" >
								<div class="row">
                                <div class="col-sm-6 col-md-6">
										<div class="form-group">
											<input type="text" class="form-control"  value="<?php echo $cause_name ?>" required="" name="d_cause">
											<div class="help-block with-errors"></div>
										</div>
									</div>
									<div class="col-sm-6 col-md-6">
										<div class="form-group">
											<input type="text" class="form-control" name="d_name" placeholder="Enter Name" required="">
											<div class="help-block with-errors"></div>
										</div>
									</div>
									<div class="col-sm-6 col-md-6">
										<div class="form-group">
											<input type="email" class="form-control" name="d_mail" placeholder="Enter Email" required="">
											<div class="help-block with-errors"></div>
										</div>
									</div>
									<div class="col-sm-6 col-md-6">
										<div class="form-group">
											<input type="text" class="form-control"  name="d_mobile" placeholder="Enter Phone Number" required="">
											<div class="help-block with-errors"></div>
										</div>
									</div>
									<div class="col-sm-6 col-md-6">
										<div class="form-group">
											<input type="text" class="form-control" name="d_amount" placeholder="Enter the amount" required="">
											<div class="help-block with-errors"></div>
										</div>
									</div>
								</div>
