...
$internship = $PDO->prepare("SELECT * FROM internships");
$internship->execute();
$internship = $internship->fetchAll(PDO::FETCH_ASSOC);
			...
			<!-- // END SUBPAGE HEAD -->
				...
				<div  class="row" id="result">
					...
					<div class="col-lg-8 mx-auto">
						<div class="shadow-lg p-3 mb-5 bg-white rounded  border border-light">
          					<h4 style="text-transform:uppercase;color:#800000;" class="p-2 h4-responsive float-left"><?=$intern['i_category'];?></h4>
          					<h5 class="p-2 h5-responsive "><span class="details-bold"> <i style="font-size:14px" class="material-icons">place</i> Location: </span><?=$intern['i_location'];?></h5>
          					<table class="table table-bordered border border-dark">
            					...
            					<tbody>
              						<tr>
                						<td  class="border border-dark"><?=$intern['i_duration'];?></td>
                						<td class="border border-dark">&#8377; <?=$intern['i_stipend'];?></td>
                						<td class="border border-dark"><?=$intern['i_applyby'];?></td>
                						<td class="border border-dark"><?=$intern['i_availposition'];?></td>
              						</tr>
            					</tbody>
          					</table>
          					<br>
           					<button type="button" style="background-color:#800000;"class="btn"><a style="color:white;" href="careers_single.php?i_id=<?php echo $intern['i_id'];?>">View Details</a></button>
        				</div>
          			</div>
