...
<html lang="en">
  <head>
	...
	<title>Save The Paws - Adoption</title>
...
<div class="container">
  ...
  <div>
    <div class="row filter_box">
      <div class="col-md-4">
        <div class="age_filter_box"> 
       <h6>Filter By Age </h6>
     </div>
      </div>
            <div class="col-md-4">
              <div class="breed_filter_box"> 
       <h6>Filter By Breed </h6>
     </div>
            </div>
      <div class="col-md-4">
         <div class="location_filter_box"> 
       <h6>Filter By Loations </h6>
     </div>
      </div>
    ...
    <h4>Your result</h4>
     ...
     <div class="error_box d-none">
  <h4 class="text-danger text-center">Something went wrong ! , please try again later <br> <br>
    <button type="button" class="btn btn-primary btn-lg"><a href="adopt.php" class="text-light">Find another</a> </button> </h4>
</div>
	 <!-- modal -->
	 <div class="modal" id="modal">
		 
<div class="modal-dialog modal-lg">
	<i class="fa fa-times close float-right" data-dismiss="modal" data-target="#modal"></i>
<div class="modal-content">
	<div class="carousel slide" data-slide="carousel" id="carousel">
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="" alt="" width="100%" id="slide_1_img">
			</div>
			<div class="carousel-item ">
				<img src="" alt="" width="100%" id="slide_2_img">
			</div>
			<div class="carousel-item ">
				<img src="" alt="" width="100%" id="slide_3_img">
			</div>
		</div>
  ...
  <a class="carousel-control-next" href="#carousel" role="button" data-slide="next">
	...
	<script src="custom_js/result.js"></script>
