...
if(isset($_GET['post_id'])){
  $id = $_GET['post_id'];
  $postss = $post->fetch_data($id);
  $post_id=$postss['post_id'];
  $post_name=$postss['post_name'];
  $post_author=$postss['post_author'];
  $post_content=$postss['post_content'];
  $post_date=$postss['pos_date'];
...
<div class="subpage-head has-margin-bottom">
  <div class="container">
    <h2 style="color:#800000"><?php echo $post_name?> </h2>
    <p class="lead" style="color:grey;">on <?php echo $new_date?> by <a href="#" class="link-reverse" style="color:#800000"><?php echo $post_author?></a></p>
  </div>
</div>
