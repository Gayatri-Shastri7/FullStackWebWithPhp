...
<div class="container">
        ...
        <div style="text-align: center!important;margin-left: auto;margin-right: auto; margin-top: 10vw;color:black;">
        <h2>THANK YOU FOR YOUR INTEREST!</h2>
        <h4>Your application has been successfully submitted!<br>If we like your application,<br>we will get back to you!</h4>
